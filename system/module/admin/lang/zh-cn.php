...
$lang->admin->shortcuts->ziliaoku  = '资料库';
$lang->admin->shortcuts->renwenguan  = '人文馆';
$lang->admin->shortcuts->tiyangong  = '体验宫';
$lang->admin->shortcuts->kuaileting  = '快乐厅';
$lang->admin->shortcuts->changxiangyuan  = '畅想园';
//$lang->admin->shortcuts->product  = '添加产品';
$lang->admin->shortcuts->feedback = '留言管理';

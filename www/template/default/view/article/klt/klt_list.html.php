...
<link href="<?php echo $themeRoot?>klt/klt_list.css" rel="stylesheet" type="text/css" />
<script>
var size;
var all_length;
var liwidth = 281;
			  ...
			  $.get("./?m=article&f=browse&categoryID=<?php echo $_GET['categoryID'] ?>&pageID="+pageID+"&moduleID=<?php echo $_GET['moduleID'] ?>&sj=json", function(result){
				...
				if(count(o_data) == 0){
					...
					for(i in o_data){
						...
						if(li_txt == ''){
							li_txt = '<li><div class="center_listtxt"><div class="center_listimg" id="center_listimg_'+o_data[i].id+'"><a href="./?m=article&f=view&id='+o_data[i].id+'&pt=<?php echo $_GET['pt'] ?>&categoryID=<?php echo $_GET['categoryID']?>" title="'+o_data[i].title+'"><img src="'+o_data[i].img_url+'" width="239" height="242"></a><div class="center_title"></div><div class="center_title_a"><a href="./?m=article&f=view&id='+o_data[i].id+'&pt=<?php echo $_GET['pt'] ?>&categoryID=<?php echo $_GET['categoryID']?>" title="'+o_data[i].title+'">'+o_data[i].title+'</a></div></div></div><div class="center_listtxtspace"></div>';
						}else{
							li_txt += '<div class="center_listtxt"><div class="center_listimg"  id="center_listimg_'+o_data[i].id+'"><a href="./?m=article&f=view&id='+o_data[i].id+'&pt=<?php echo $_GET['pt'] ?>&categoryID=<?php echo $_GET['categoryID']?>" title="'+o_data[i].title+'"><img src="'+o_data[i].img_url+'" width="239" height="242"></a><div class="center_title"></div><div class="center_title_a"><a href="./?m=article&f=view&id='+o_data[i].id+'&pt=<?php echo $_GET['pt'] ?>&categoryID=<?php echo $_GET['categoryID']?>" title="'+o_data[i].title+'">'+o_data[i].title+'</a></div></div></div></li>';
						//	if(n < count(o_data) -1){
